 ...
 * @author rakawm
 */
public class GetJagatPlayPSInteractorImpl extends AbstractInteractor implements GetJagatPlayPSInteractor {
    private int page;
    private Callback callback;
    private MainRepository repository;

    public GetJagatPlayPSInteractorImpl(InteractorExecutor interactorExecutor, MainThreadExecutor mainThreadExecutor) {
        super(interactorExecutor, mainThreadExecutor);
        this.repository = new NewsFeedRepository("http://jagatplay.com/read/playstation3/");
    }
