 ...
 * @author rakawm
 */
public class GetJagatPlayPCInteractorImpl extends AbstractInteractor implements GetJagatPlayPCInteractor {
    private int page;
    private Callback callback;
    private MainRepository repository;

    public GetJagatPlayPCInteractorImpl(InteractorExecutor interactorExecutor, MainThreadExecutor mainThreadExecutor) {
        super(interactorExecutor, mainThreadExecutor);
        this.repository = new NewsFeedRepository("http://jagatplay.com/read/pc-2/");
    }
