 ...
 * @author rakawm
 */
public class GetJagatOcCompetitionInteractorImpl extends AbstractInteractor implements GetJagatOcCompetitionInteractor {
    private int page;
    private Callback callback;
    private MainRepository repository;

    public GetJagatOcCompetitionInteractorImpl(InteractorExecutor interactorExecutor, MainThreadExecutor mainThreadExecutor) {
        super(interactorExecutor, mainThreadExecutor);
        this.repository = new NewsFeedRepository("http://www.jagatoc.com/category/competition/");
    }
