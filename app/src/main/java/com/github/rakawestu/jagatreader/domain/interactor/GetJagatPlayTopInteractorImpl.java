 ...
 * @author rakawm
 */
public class GetJagatPlayTopInteractorImpl extends AbstractInteractor implements GetJagatPlayTopInteractor {
    private int page;
    private Callback callback;
    private MainRepository repository;

    public GetJagatPlayTopInteractorImpl(InteractorExecutor interactorExecutor, MainThreadExecutor mainThreadExecutor) {
        super(interactorExecutor, mainThreadExecutor);
        this.repository = new NewsFeedRepository("http://jagatplay.com/read/top-list-2/");
    }
